...
# Keep all other handlers (upload, list, callbacks, healthcheck, etc.) from your original file intact.
# The only difference: replace direct filename usage with `find_closest_filename()` before Wasabi API calls.
