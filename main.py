...
async def play_file_handler(client, message: Message):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("⬇️ Download File", callback_data=f"download_{file_name}")]
        ])
        ...
        await status_message.edit_text(
            ...
            f"<b>Direct URL:</b>\n<code>{escape_html(stream_url)}</code>",
            parse_mode=ParseMode.HTML,
...
async def handle_download_callback(client, callback_query):
    ...
    file_name = callback_query.data.replace("download_", "")
...
async def upload_file_handler(client, message: Message):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🎬 Stream Online", callback_data=f"play_{os.path.basename(file_path)}")],
            [InlineKeyboardButton("⬇️ Download Again", callback_data=f"download_{os.path.basename(file_path)}")]
        ])
