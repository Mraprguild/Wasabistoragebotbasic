...
async def progress_callback(current, total, message, start_time, action, last_update=[0]):
    ...
    if elapsed_time - last_update[0] < 2:
        return
    last_update[0] = elapsed_time
...
async def file_handler(_, message: Message):
    ...
    def upload_progress(chunk):
        ...
        asyncio.get_event_loop().create_task(
            progress_callback(uploaded, file_size, status_message, start_time, "Uploading")
        )
...
# --- Web Server for Render (Port 5000) ---
